...
Future<SubscriptionsResponse>getSubscriptions();
  ...
  //Future<ProgramResponse> getProgram();
...
class RemoteDataSourceImpl implements RemoteDataSource{
  ...
  Future<RegisterAResponse> register(SignUpRequest signUpRequest)async {
    return await  _appServiceClient.register(
      ...
      signUpRequest.area_id,signUpRequest.street,signUpRequest.subscription_id
      ,signUpRequest.firstName,signUpRequest.lastName,
      signUpRequest.email,signUpRequest.password,
      signUpRequest.phoneNumber,
      signUpRequest.transportation_line_id,signUpRequest.transfer_position_id,
      signUpRequest.university_id, image:signUpRequest.image,

    );
  }
  @override
  Future<UpdateStResponse> updateStudent(UpdateStudentRequest updateStudentRequest) async{
return  await _appServiceClient.updateStudent(
    updateStudentRequest.studentId,
    city_id :updateStudentRequest.city_id,
    area_id:  updateStudentRequest.area_id,street: updateStudentRequest.street,
    subscription_id:   updateStudentRequest.subscription_id,firstName: updateStudentRequest.firstName,
   ...
   // oldPassword: updateStudentRequest.oldPassword, newPassword:updateStudentRequest.newPassword,
    ...
    phoneNumber:  updateStudentRequest.phoneNumber,transportation_line_id: updateStudentRequest.transportation_line_id,
    transfer_position_id: updateStudentRequest.transfer_position_id, image:updateStudentRequest.image,
    university_id:updateStudentRequest.university_id);
  }
  Future<UpdateStResponse> updateStudentt(UpdateStudentRequest updateStudentRequest) async{
  ...
  @override
  Future<UpdateStResponse> updatePassword(UpdatePasswordRequest updatePasswordRequest) async{
    return await _appServiceClient.updatePassword(
        ...
        PasswordRequest(
          ...
          newPassword_confirmation: updatePasswordRequest.newPassword_confirmation
  ...
  // @override
  // Future<ProgramResponse> getProgram()async {
  //   return await _appServiceClient.getProgram();
  // }
