...
LocationDataResponse _$LocationDataResponseFromJson(
    ...
    LocationDataResponse(
      ...
      json['area'] == null
          ? null
          : CityResponse.fromJson(json['area'] as Map<String, dynamic>),
      json['street'] as String?,
    );
...
//     };
//
// TranferPositionResponse _$TranferPositionResponseFromJson(
//         Map<String, dynamic> json) =>
//     TranferPositionResponse(
//       name: json['name'] as String?,
//     );
//
// Map<String, dynamic> _$TranferPositionResponseToJson(
//         TranferPositionResponse instance) =>
//     <String, dynamic>{
//       'name': instance.name,
//     };
//
// StudentProgramResponse _$StudentProgramResponseFromJson(
//         Map<String, dynamic> json) =>
//     StudentProgramResponse(
//       day: json['day'],
//       transfer_position: json['transfer_position'],
//       start: json['start'] as String?,
//       end: json['end'] as String?,
//       confirmAttendance1: json['confirmAttendance1'] as String?,
//       confirmAttendance2: json['confirmAttendance2'] as String?,
//     );
//
// Map<String, dynamic> _$StudentProgramResponseToJson(
//         StudentProgramResponse instance) =>
//     <String, dynamic>{
//       'day': instance.day,
